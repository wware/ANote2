...
//clase con métodos estáticos comunes que podrían ser reutilizables por distintas clases
public final class Comun
{
  ...
  //busca la primera ocurrencia de la segunda cadena dentro de la primera
  //a partir de la posición indicada, ignorando mayúsculas y minúsculas
  ...
  //indica si la url dada está contenida en la lista indicada
...
//		}catch(NullPointerException e){}
  ...
  //añade la url a la lista indicada si no estaba ya en ella
...
//	  }
  ...
  //comprueba si una página es HTML dado su código fuente
  ...
  //comprueba si una página es un PDF dado su código fuente
  ...
  //convierte los caracteres raros de la cadena a UTF para que pueda ser una URL válida
  public static String getUTF8String(String cad)
  {
	try
	{
	  ...
	  {
	    char c=cad.charAt(i);
	    //entre ! y z se encuentran los caracteres más habituales de UTF-8 y no deberían
	    //dar error al introducirlos tal cual están en una URL
	    if(c>='!' && c<='z' && c!='[' && c!=']') cad2+=c;
	    else
	    {
