...
public class ChangeResourcesGUI extends DialogGenericView{
	...
	private void initGUI() throws SQLException, DatabaseLoadDriverException {
		{
			...
			getContentPane().setLayout(thisLayout);
			{
				...
				jPanelAvailableDics.setBorder(BorderFactory.createTitledBorder(BorderFactory.createTitledBorder(""), "Available Lookup Tables", TitledBorder.LEADING, TitledBorder.TOP));
			...
			}
			{
				...
				jPanelSelectedDic.setBorder(BorderFactory.createTitledBorder(BorderFactory.createTitledBorder(""), "Selected Lookup Table", TitledBorder.LEADING, TitledBorder.TOP));
	...
	private DefaultComboBoxModel getLookupTables() throws SQLException, DatabaseLoadDriverException{
		...
		while(rs.next())
		{
			...
			name = rs.getString(3);
			note = rs.getString(4);
			if(type.equals(GlobalOptions.resourcesLookupTableName))
			{
				model.addElement(new LookupTable(id, name, note));
			}
		}
		rs.close();
		return model;
	...
	private void changeDicResource() throws SQLException, DatabaseLoadDriverException
	{
