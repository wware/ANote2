package pt.uminho.generic.components;
 ...
 */
public class JSliderDouble extends JComponent implements MouseListener,
     ...
     */
    public JSliderDouble(DoubleBoundedRangeModel model) {
        this.model = model;
