...
public class OntologyOBOLoaderGUI extends DialogGenericViewInputGUI{
	...
	public OntologyOBOLoaderGUI() {
		super("Load OBO 1.0 Ontology");
		initGUI();
		this.setModal(true);
	}
	...
	protected void okButtonAction() {
		...
		else
		{
			...
			OBOOntologyExtensionv1p0 ontoLoder = new OBOOntologyExtensionv1p0(onto, onto.getName(), progress );
