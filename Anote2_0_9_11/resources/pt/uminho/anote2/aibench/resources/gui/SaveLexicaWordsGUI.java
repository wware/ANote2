...
public class SaveLexicaWordsGUI extends DialogGenericViewInputGUI{
	...
	private LexicalWordsAibench lex;
	
	public SaveLexicaWordsGUI()
	{
		lex = (LexicalWordsAibench) HelpAibench.getSelectedItem(LexicalWordsAibench.class);
		initGUI();
		this.setTitle("Export Lexical Words to CSV File");
		this.setModal(true);
	}
				...
				public void actionPerformed(ActionEvent arg0) {
					...
					else
					{
						...
						if(save_path.isDirectory())
						{
							...
							jTextFieldTextChooser.setText(save_path.getAbsolutePath()+"/"+"lexicawords_"+lex.getID()+".tsv");
						}
						else
						{
	...
	protected void okButtonAction() {
		...
		else 
		{
			this.paramsRec.paramsIntroduced( new ParamSpec[]{
					new ParamSpec("lexicalwords", LexicalWordsAibench.class,lex, null),
	...
	protected String getHelpLink() {
		return GlobalOptions.wikiGeneralLink+"LexicalWords_Export_To_CVS_File";
	}
