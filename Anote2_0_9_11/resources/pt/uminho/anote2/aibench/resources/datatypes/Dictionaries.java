...
public class Dictionaries extends Observable implements Serializable{
	...
	{	
		if(alreadyExist(dic))
		{
			new ShowMessagePopup("Dictionary Already In Clipboard.");
		}
		else
		{
			this.dics.add(dic);
			new ShowMessagePopup("Dictionary Added To Clipboard.");
			notifyViewObservers();
		}
	}
	...
	public List<DictionaryAibench> getDictionariesClipboard()
	{
		return this.dics;
	}
