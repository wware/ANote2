...
public class OtherConfigurations {
	...
	public static String getVerbColor() {
		if(GlobalOptions.verbColor == null)
		{
			...
			List<String> data = Configuration.getElementByXMLFile(GlobalOptions.otherConfigurationFile,elements);
	...
	public static void setVerbColor(String verbColor) {
		...
		Configuration.setXmlProperties(GlobalOptions.otherConfigurationFile, changes);	
	...
	public static boolean getUsingTitleInAbstract() {
		if(GlobalOptions.usingTitleInAbstract == null)
		{
			ArrayList<String> elements = new ArrayList<String>();
			...
			{
				setUsingTitleInAbstract(false);
			}
		}
		return GlobalOptions.usingTitleInAbstract;
	}
