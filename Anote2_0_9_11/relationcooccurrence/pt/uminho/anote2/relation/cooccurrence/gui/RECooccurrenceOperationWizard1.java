...
public class RECooccurrenceOperationWizard1  extends WizardStandard{
	...
	public RECooccurrenceOperationWizard1() throws SQLException, DatabaseLoadDriverException{
	...
	public RECooccurrenceOperationWizard1(List<Object> objects) throws SQLException, DatabaseLoadDriverException {
		super(new ArrayList<Object>());
		initGUI();
		this.setModal(true);
		this.setTitle("Relation Cooccurrence Extraction - Entity Schema Selection");
...
//				e.printStackTrace();	
	...
	public DefaultComboBoxModel getIEProcessComboBoxModel() throws SQLException, DatabaseLoadDriverException
	{
		...
		if(proce.size()==0)
		{
			Workbench.getInstance().warn("IE Processes do not exist");
			finish();
		}
	...
	public void goNext() {
		if(isselectNERSchemahasEntities())
		{
			...
			closeView();
			new RECooccurrenceOperationWizard2(param);
		}
		else
		{
	...
	public String getHelpLink() {
		return GlobalOptions.wikiGeneralLink+"Corpus_Relation_Co-occurrence_Extraction#Entity_Process_Selection";
	}
