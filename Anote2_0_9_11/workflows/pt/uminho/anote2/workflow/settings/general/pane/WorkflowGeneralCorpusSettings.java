...
public class WorkflowGeneralCorpusSettings extends JPanel{
	...
	public WorkflowGeneralCorpusSettings(Map<String, Object> initial_props)
	{
	...
	private void fillSettings() {
		jTextFieldCorpusName.setText(initial_props.get(WorkflowGeneralDefaulSettings.CORPUS_NAME).toString());
		jComboBoxCorpusType.setSelectedItem(initial_props.get(WorkflowGeneralDefaulSettings.CORPUS_TYPE));
		jCheckBoxRetievalPDF.setSelected(Boolean.parseBoolean(initial_props.get(WorkflowGeneralDefaulSettings.CORPUS_RETRIEVAL_PDF).toString()));
	}
	...
	public Map<String, Object> getProperties() {
		...
		settings.put(WorkflowGeneralDefaulSettings.CORPUS_NAME, jTextFieldCorpusName.getText());
		settings.put(WorkflowGeneralDefaulSettings.CORPUS_TYPE, jComboBoxCorpusType.getSelectedItem());
		settings.put(WorkflowGeneralDefaulSettings.CORPUS_RETRIEVAL_PDF, jCheckBoxRetievalPDF.isSelected());
		return settings;
	}


	public boolean haveChanged() {
		if(!initial_props.get(WorkflowGeneralDefaulSettings.CORPUS_NAME).equals(jTextFieldCorpusName.getText()))
		{
			return true;
		}
		else if(!initial_props.get(WorkflowGeneralDefaulSettings.CORPUS_TYPE).equals(jComboBoxCorpusType.getSelectedItem()))
		{
			return true;
		}
		else if(!initial_props.get(WorkflowGeneralDefaulSettings.CORPUS_RETRIEVAL_PDF).equals(jCheckBoxRetievalPDF.isSelected()))
		{
			return true;
		}
		return false;
