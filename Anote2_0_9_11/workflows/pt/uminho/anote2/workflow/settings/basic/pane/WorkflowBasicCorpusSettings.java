...
public class WorkflowBasicCorpusSettings extends JPanel{
	...
	public WorkflowBasicCorpusSettings(Map<String, Object> initial_props)
	{
	...
	private void fillSettings() {
		jTextFieldCorpusName.setText(initial_props.get(WorkflowBasicsDefaulSettings.CORPUS_NAME).toString());
		jComboBoxCorpusType.setSelectedItem(initial_props.get(WorkflowBasicsDefaulSettings.CORPUS_TYPE));
		jCheckBoxRetievalPDF.setSelected(Boolean.parseBoolean(initial_props.get(WorkflowBasicsDefaulSettings.CORPUS_RETRIEVAL_PDF).toString()));
	}
	...
	public Map<String, Object> getProperties() {
		...
		settings.put(WorkflowBasicsDefaulSettings.CORPUS_NAME, jTextFieldCorpusName.getText());
		settings.put(WorkflowBasicsDefaulSettings.CORPUS_TYPE, jComboBoxCorpusType.getSelectedItem());
		settings.put(WorkflowBasicsDefaulSettings.CORPUS_RETRIEVAL_PDF, jCheckBoxRetievalPDF.isSelected());
		return settings;
	}


	public boolean haveChanged() {
		if(!initial_props.get(WorkflowBasicsDefaulSettings.CORPUS_NAME).equals(jTextFieldCorpusName.getText()))
		{
			return true;
		}
		else if(!initial_props.get(WorkflowBasicsDefaulSettings.CORPUS_TYPE).equals(jComboBoxCorpusType.getSelectedItem()))
		{
			return true;
		}
		else if(!initial_props.get(WorkflowBasicsDefaulSettings.CORPUS_RETRIEVAL_PDF).equals(jCheckBoxRetievalPDF.isSelected()))
		{
			return true;
		}
		return false;
