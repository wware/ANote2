...
public class SelectionQueryPane extends AWorkflowSelectionPane{
	...
	private void initGUI() {
		{
			...
			this.setLayout(thisLayout);
			{
				...
				jRadioButtonPubmedSearch.setText("Selecting Publications (Query)");
			...
			}
			{
				...
				jRadioButtonCreateCorpus.setEnabled(false);
			}
			{
