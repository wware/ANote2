...
public class NERPanel extends JPanel{
	...
	public NERPanel(INERProcessReport report)
	{
		this.report = report;
		initGUI();
		completeGUI();
	...
	private void completeGUI() {
		...
		jTextFieldEntityAnnotations.setText(String.valueOf(report.getNumberOFEntities()));
	}
	...
	private void initGUI() {
		{
			...
			}
			{
				...
				jLabelEntitiesAnnotated.setText("Entity Annotations :");
			}
			{
