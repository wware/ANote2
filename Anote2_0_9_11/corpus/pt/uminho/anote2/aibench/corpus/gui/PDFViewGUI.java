 ...
 * 
 */
public class PDFViewGUI extends DialogGenericViewOkButtonOnly {

	
	/**
	 * 
	 */
	private static final long serialVersionUID = -1725905489829166742L;
	 ...
	 */
	public PDFViewGUI(PDF pdf){
		super();
		String name = pdf.getFilepath();
...
//		check if file is encrypted
	...
	private JScrollPane initPDFDisplay() {
		...
		currentScroll.setHorizontalScrollBarPolicy(ScrollPaneConstants.HORIZONTAL_SCROLLBAR_AS_NEEDED);
