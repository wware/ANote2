...
public class RelationDetaillsPanel extends JPanel{
	...
	public RelationDetaillsPanel(IEventAnnotation event,IIEProcess process) throws SQLException, DatabaseLoadDriverException, RelationDelimiterExeption
	{
		super();
	...
	private void initGUI() {
		...
		downPanelLayout.rowWeights = new double[] {0.15, 0.4, 0.4};
		downPanelLayout.rowHeights = new int[] {7, 7, 7};
		downPanelLayout.columnWeights = new double[] {0.1};
		downPanelLayout.columnWidths = new int[] {7};
		this.setLayout(downPanelLayout);
		{
			jScrollSentence = new JScrollPane();
			this.add(jScrollSentence, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(10, 10, 10, 10), 0, 0));
			{
		...
		}
		{
			...
			this.add(jPanelRelationClueAndProperties, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
		...
		}
		{
			...
			this.add(jPanelRelationSideEntities, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
