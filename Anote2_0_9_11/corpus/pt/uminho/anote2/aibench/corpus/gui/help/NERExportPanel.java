...
public class NERExportPanel extends JPanel{
	...
	public NERExportPanel(INERSchemaExportReport report)
	{
		this.report = report;
		initGUI();
		completeGUI();
	...
	private void completeGUI() {
		...
		jTextFieldEntityAnnotations.setText(String.valueOf(report.entitiesExported()));
	}
