...
public class IRSearchReportGUI extends DialogGenericViewOkButtonOnly{
	...
	public IRSearchReportGUI(IIRSearchProcessReport report)
	{
	...
	private void initGUI() {
		...
		{
			getContentPane().add(new IRSearchPanelReport(report), new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));	
		}
		{
