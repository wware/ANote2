...
public class ParsingUtils {
	...
	/* Converts special characters to their html code */
	public static String convertSpecialChars(String text){
		...
		res = res.replace(">", "&gt;");
		res = res.replace("<", "&lt;");
		res = res.replace("±", "&plusmn;");
		res = res.replace("µ", "&micro;");
		res = res.replace("§", "&sect;");
		res = res.replace("¥", "&yen;");
	...
	/* Converts special characters to their html code */
	public static String convertToSpecialChars(String text){
		String res = text;
		...
		res = res.replace("&lt;", "<");
		res = res.replace("&plusmn;", "±");
		res = res.replace("&micro;", "µ");
		res = res.replace("&sect;", "§");
		res = res.replace("&yen;", "¥");
		res = res.replace("&para;", "¶");
		res = res.replace("&alpha;", "alpha");
		res = res.replace("&beta;", "beta");
