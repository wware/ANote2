...
public abstract class SimpleDialogView extends JDialog implements InputGUI{
	...
	public void finish() {
		...
		this.dispose();
		Workbench.getInstance().warn("Operation Create a Corpus Cancel");
		return;
	}
	...
	private JButton getJButtonHelp() {
		if(jButtonHelp == null) {
			...
			jButtonHelp.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent evt) {
					Help.internetAcess(GlobalOptions.wikiGeneralLink+"Corpus_Create_Annotation_Schema_By_NER_Lexical_Resources");
				}
			});
