...
*/
public class REProcessRelationsResumeStats extends JPanel{
	...
	private JTextField jTextFieldCondicional;
	private JLabel jLabelCondicional;
	...
	public REProcessRelationsResumeStats(REProcess reprocess)
	{
		this.reprocess = reprocess;
		this.verdIDcount = new HashMap<String, Integer>();
		polarity = new int[4];
		directionality = new int[3];
	...
	private void fillStats()
	{
		...
		if(total!=0)
		{
			...
			neg = String.valueOf(round2.format((float)polarity[1]*100/(float)total)+" %");
			cod = String.valueOf(round2.format((float)polarity[0]*100/(float)total)+" %");
		}
		jTextFieldPositive.setText(pos);
		jTextFieldNegative.setText(neg);
		jTextFieldCondicional.setText(cod);
		jTextFieldPolarityUnknown.setText(unknown);
		// Para a direcionalidade
		String lr="Na";
		String rl="Na";
		String un = "Na";
		total = directionality[0]+directionality[1]+directionality[2];
		if(total!=0)
		{
	...
	private void polarity(IEventAnnotation event)
	{
		...
		{
			int polarity = event.getEventProperties().getPolarity();
			if(polarity==-1){
				this.polarity[0]++;
			}
			else if(polarity==0){
				...
				this.setLayout(thisLayout);
				{
					...
					jButtonHelp.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent evt) {
							Help.internetAcess(GlobalOptions.wikiGeneralLink+"Process_Relations_Resume_Stats");
						}
					});
				...
				}
				{
					...
					jPanel3Stats.setLayout(jPanel3StatsLayout);
					{
						...
						jPanel3Stats.add(jScrollPanePolarity, new GridBagConstraints(0, 0, 1, 2, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
						{
							...
							{
								jLabelCondicional = new JLabel();
								jPanelPolarity.add(jLabelCondicional, new GridBagConstraints(1, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
								jLabelCondicional.setText("Condicional");
							}
							{
								jTextFieldCondicional = new JTextField();
								jPanelPolarity.add(jTextFieldCondicional, new GridBagConstraints(2, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
								jTextFieldCondicional.setEditable(false);
								jTextFieldCondicional.setBackground(Color.WHITE);
							}
							{
								Unknown = new JLabel();
					...
					}
					{
						...
						jPanel3Stats.add(jScrollPaneDirecionaly, new GridBagConstraints(2, 0, 1, 2, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
						{
							...
							}
							{
								...
								jPanelDirectionality.add(jLabelDirectionallyUnknown, new GridBagConstraints(1, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
								jLabelDirectionallyUnknown.setText("Unknown");
							}
							{
								jTextFieldDirectionallyUnknown = new JTextField();
								jPanelDirectionality.add(jTextFieldDirectionallyUnknown, new GridBagConstraints(2, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
