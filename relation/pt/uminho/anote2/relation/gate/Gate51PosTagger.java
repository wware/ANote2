 ...
 *
 */
public class Gate51PosTagger implements IGatePosTagger{
	...
	public Gate51PosTagger() throws GateException 
	{
		this.gateDoc = null;
	...
	public Gate51PosTagger(IDirectionality rulesDir,IPolarity rulesPol) throws GateException 
	{
		this.gateDoc = null;
	 ...
	 * 
	 */
	private void tokeniser() throws ResourceInstantiationException, ExecutionException
	{	
		FeatureMap features = Factory.newFeatureMap();
		FeatureMap params = Factory.newFeatureMap();
...
//	}
	...
	{
		Gate51PosTagger gate = new Gate51PosTagger();
		File file = new File("gate/fileTmp.xml");
		gate.completePLSteps(file);
	}
	...
	public GenericPair<List<IVerbInfo>, List<Long>> getSentenceSintaticLayer(Set<String> termionations, GenericPair<Long, Long> setenceLimits) {
		Long endSentence = setenceLimits.getY();
		Long startSentence = setenceLimits.getX();
		List<IVerbInfo>  verbsInfo = processSintaticSentence(startSentence,endSentence);
	...
	public List<IVerbInfo> processSintaticSentence(long startOffsetSentence,long endOffsetSentence) 
	{
		...
		while(itAnnot.hasNext())
		{
			...
			IVerbInfo verbInfoAux = new VerbInfo(startAnnot,endAnnot,verb,lemma,polarity);
			...
			verbInfo = new VerbInfo(verb,lemma.toLowerCase(),polarity,verbVoice,verbTense,directional,startAnnot,endAnnot);	
	...
	public GenericPair<List<IVerbInfo>, List<Long>> getSentenceSintaticLayer(
			Set<String> termionations, GenericPair<Long, Long> setenceLimits,
	...
	private List<IVerbInfo> processSintaticSentence(long startOffsetSentence,long endOffsetSentence,long offsetCorrection) 
	{
		List<IVerbInfo> verbsInfo = new ArrayList<IVerbInfo>();
		AnnotationSet allAnnottaions = getGateDoc().getAnnotations();
		allAnnottaions = allAnnottaions.getContained(startOffsetSentence, endOffsetSentence);
