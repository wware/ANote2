...
public class CreateLookupTableGUI extends DialogGenericView{
	...
	private void confirmDataTypes() {
		...
		{
			Workbench.getInstance().warn("No LookupTables on clipboard");
			return;
		}
	}
	...
	private void initGUI() 
	{
		...
		getContentPane().setLayout(thisLayout);
		{
			...
			jPanelUpper.setBorder(BorderFactory.createTitledBorder(BorderFactory.createTitledBorder(""), "LookupTable Information", TitledBorder.LEADING, TitledBorder.TOP));
	...
	if(!this.jTextPaneName.getText().equals(""))
	{
		...
		paramsRec.paramsIntroduced( new ParamSpec[]{ 
				new ParamSpec("lookuptables",Dictionaries.class,look,null),
