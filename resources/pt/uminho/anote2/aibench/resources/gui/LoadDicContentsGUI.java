...
*/
public class LoadDicContentsGUI extends DialogGenericView{
	...
	
			{
				...
				getContentPane().setLayout(thisLayout);		
				{
					...
					}
					{
						...
						getContentPane().add(jPanelBioWareHouse, new GridBagConstraints(0, 4, 5, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
